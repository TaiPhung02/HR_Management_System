      ...
      <div className="addnew__salary">
        <form action="" autoComplete="off" onSubmit={handleSubmit}>
          <div className="addnew__salary-input-box">
            <label htmlFor="basic_salary" className="addnew__salary-label">
              Basic Salary<span className="required">*</span>
            </label>
            <div>
              <div className="addnew__salary-number-box">
                <span className="addnew__salary-number-desc">RP</span>
                <input
                  id="basic_salary"
                  type="number"
                  className={
              ...
              {touched.basic_salary && errors.basic_salary && (
                <p className="login__message-error">{errors.basic_salary}</p>
              )}
            </div>
          </div>
          <div className="addnew__salary-input-box">
            <label htmlFor="audit_salary" className="addnew__salary-label">
              Basic Salary (Audit)
            ...
            <div>
              <div className="addnew__salary-number-box">
                ...
                <input
                  ...
                  id="audit_salary"
                  className={
                    errors.audit_salary && touched.audit_salary
                      ? "addnew__salary-number error"
                      : "addnew__salary-number"
                  }
              ...
              {touched.audit_salary && errors.audit_salary && (
                <p className="login__message-error">{errors.audit_salary}</p>
              )}
            </div>
          </div>
          <div className="addnew__salary-input-box">
            <label htmlFor="health_insurance" className="addnew__salary-label">
          ...
          <div className="addnew__salary-input-box">
            <label htmlFor="meal_allowance" className="addnew__salary-label">
              Meal Allowance
              <span className="required">*</span>
            </label>
            <div>
              <div className="addnew__salary-number-box">
                ...
                <input
                  ...
                  id="meal_allowance"
                  className={
                    errors.meal_allowance && touched.meal_allowance
                      ? "addnew__salary-number error"
                      : "addnew__salary-number"
                  }
              ...
              {touched.meal_allowance && errors.meal_allowance && (
                <p className="login__message-error">{errors.meal_allowance}</p>
              )}
            </div>
          </div>
          <div className="addnew__salary-input-box">
            <label htmlFor="safety_insurance" className="addnew__salary-label">
            ...
            <div>
              <div className="addnew__salary-number-box">
                ...
                <input
                  ...
                  id="safety_insurance"
                  className={
                    errors.safety_insurance && touched.safety_insurance
                      ? "addnew__salary-number error"
                      : "addnew__salary-number"
                  }
              ...
              {touched.safety_insurance && errors.safety_insurance && (
                <p className="login__message-error">
