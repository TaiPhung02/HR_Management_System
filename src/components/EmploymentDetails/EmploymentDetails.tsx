...
const EmploymentDetails: React.FC<EmploymentDetailsProps> = ({
  ...
  const { values, setValues, handleChange, errors, touched } = useFormik({
      ...
      const fetchEmployeeData = async () => {
        try {
          ...
          const updatedEmployeeData = {
            ...
            meal_allowance_paid: employeeData.meal_allowance_paid === 1,
          };
    ...
    <div className="addnew-container">
      ...
      <div className="addnew__employment">
        <div className="addnew__employment-input-box">
          <label htmlFor="department_id" className="addnew__employment-label">
            Department
          </label>
          <select
            id="department_id"
        ...
        <div className="addnew__employment-input-box">
          <label htmlFor="position_id" className="addnew__employment-label">
            Position
          </label>
          <select
            id="position_id"
        ...
        {touched.hidden_on_payroll && errors.hidden_on_payroll && (
          <p className="login__message-error">{errors.hidden_on_payroll}</p>
        )}
        <div className="addnew__employment-checkbox-box">
          <Checkbox
            id="entitle_ot"
            ...
            onChange={handleChange}
          />
          <label htmlFor="entitle_ot" className="addnew__employment-label">
            Entitled OT
          </label>
        </div>
        <div className="addnew__employment-checkbox-box">
